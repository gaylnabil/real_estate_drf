...
SECRET_KEY = 'django-insecure-#z(4o5(85msy@1^71md5c2g@tr^3reovpegblgd(w1o8_wh8(y'
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'rest_framework',
    'predictor',  # Your app for handling CSV uploads
]
...
# Configure DRF parsers for file uploads
REST_FRAMEWORK = {
...
CORS_ALLOW_HEADERS = [
    ...
    'x-csrftoken',
    'x-requested-with',
    # Add any custom headers you're using
]
